...
export function Root({ className, ...props }: ComponentProps<typeof RadixTabs.Root>) {
...
export function List({ className, ...props }: ComponentProps<typeof RadixTabs.List>) {
  return (
    <RadixTabs.List data-slot="tabs-list" className={clsx(styles.list, className)} {...props} />
  );
}
...
export function Content({ className, ...props }: ComponentProps<typeof RadixTabs.Content>) {
  return (
    <RadixTabs.Content
