...
export function Viewport({
  className,
  ...props
}: ComponentProps<typeof RadixToast.Viewport>) {
...
export function Root({
  className,
  ...props
}: ComponentProps<typeof RadixToast.Root>) {
...
export function Title({
  className,
  ...props
}: ComponentProps<typeof RadixToast.Title>) {
...
export function Close({
  className,
  ...props
}: ComponentProps<typeof RadixToast.Close>) {
